...
If your bluprint has [parts](/bluprint/guides/parts/), `preview` prompts for one just like
...
a **registered** bluprint into a real project, use [`start`](/bluprint/guides/using/).
:::
