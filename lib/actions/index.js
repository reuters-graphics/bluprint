...
import getDefaultContext from '../utils/getDefaultContext';
...
const routeAction = async(action, context, updateContext) => {
...
export default async(actions, bluprintPart) => {
  ...
  let context = { bluprintPart, ...getDefaultContext() };
